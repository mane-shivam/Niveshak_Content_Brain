...
## 🔵 THREE-TIER CLAIM DOCTRINE

**TIER 1 — HARD FACTS** (This engine's strict authority)
- Financial numbers, quarters, fiscal years
- Regulatory actions, management quotes
- Survey data, official disclosures
- **Rules:** Must be sourceable, any error must be corrected or removed

**TIER 2 — REASONING & INTERPRETATION** (PROTECTED, outside this engine's authority)
- Mechanisms, incentive analysis, regime reasoning
- Pattern recognition, cross-sector analogies
- Framework application
- **Rules:** Must logically follow Tier 1, no source required, CANNOT BE DELETED

**TIER 3 — SPECULATION** (Must be deleted)
- Forecasts, targets, timing, predictions
- **Rules:** Always removed

**Only Tier 1 and Tier 3 are this engine's authority.**
**Tier 2 is protected and cannot be touched.**
...
STEP 2 — KILL TIER 3  
List all Tier 3 speculation that must be removed.

STEP 3 — SOURCE QUALITY CHECK  
Flag:
- Weak sources  
- Secondary-only claims  
- Any hallucinated quarter / period  
...
- Do NOT propose new thesis  

OUTPUT FORMAT STRICTLY AS BELOW.
```
